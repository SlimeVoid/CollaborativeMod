package com.slimevoid.collaborative.container.slot;
        ...
        if (plan != null) {
            for (int i = 0; i < 9; i++) {
                ...
                p.inventoryMatch.decrStackSize(p.slotIndex,
                                               1);
                if (is2.getItem().hasContainerItem(is2)) {
                    ItemStack is3 = is2.getItem().getContainerItem(is2);
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (nsl != null) {
                if (ItemLib.matchOre(nsl,
                                     cur[i])
                    || !cur[i].getItem().hasContainerItem(cur[i])) {
                    continue;
                }
