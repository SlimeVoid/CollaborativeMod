package net.slimevoid.collaborative.container;
...
import net.slimevoid.collaborative.container.slot.SlotCraftRefill;
import net.slimevoid.collaborative.container.slot.SlotPlan;
...
import net.slimevoid.collaborative.inventory.InventoryMatch;
import net.slimevoid.collaborative.inventory.InventorySubCraft;
...
public class ContainerWorkBench extends ContainerBase {
    ...
    public void handleGuiEvent(PacketGui packet) {
        ...
        if (blank == null
            || blank.getItem().getClass().isInstance(ConfigurationLib.itemPlanBlank.getClass())) {
            return;
        }
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (is1 != null) {
                ItemStack ist = new ItemStack(is1.getItem(), 1, is1.getItemDamage());
